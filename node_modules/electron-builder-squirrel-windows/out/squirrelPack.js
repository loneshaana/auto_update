...
class SquirrelBuilder {
  ...
  buildInstaller(outFileNames, appOutDir, outDir, arch) {
    ...
    return (0, _bluebirdLst().coroutine)(function* () {
      ...
      yield (0, _wine().execWine)(path.join(options.vendorPath, "WriteZipToSetup.exe"), [setupPath, embeddedArchiveFile]);
  ...
  releasify(nupkgPath, packageName) {
    ...
    return (0, _bluebirdLst().coroutine)(function* () {
      ...
      const out = (yield execSw(_this2.options, args)).trim();
...
function pack(_x, _x2, _x3, _x4, _x5, _x6) {
  return _pack.apply(this, arguments);
}

function _pack() {
  _pack = (0, _bluebirdLst().coroutine)(function* (options, directory, updateFile, outFile, version, packager) {
...
function msi(_x7, _x8, _x9, _x10, _x11) {
  return _msi.apply(this, arguments);
}

function _msi() {
  _msi = (0, _bluebirdLst().coroutine)(function* (options, nupkgPath, setupPath, outputDirectory, outFile) {
    const args = ["--createMsi", nupkgPath, "--bootstrapperExe", setupPath];
    yield execSw(options, args); //noinspection SpellCheckingInspection
...
function encodedZip(_x12, _x13, _x14, _x15, _x16) {
  return _encodedZip.apply(this, arguments);
} function _encodedZip() {
  _encodedZip = (0, _bluebirdLst().coroutine)(function* (archive, dir, prefix, vendorPath, packager) {
    yield (0, _fs().walk)(dir, null, {
      isIncludeDir: true,
      consume: function () {
        var _ref = (0, _bluebirdLst().coroutine)(function* (file, stats) {
          ...
          if (file.endsWith(".exe") && !file.includes("squirrel.exe") && !relativeSafeFilePath.includes("/")) {
            ...
            yield (0, _wine().execWine)(path.join(vendorPath, "WriteZipToSetup.exe"), ["--copy-stub-resources", file, tempFile]);
